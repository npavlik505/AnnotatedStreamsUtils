...
HDF5 1.10 that was compiled on;
    Linux 6.8.0-40-generic x86_64, using GNU C 13.2.0.
...
The contents of this directory are:
    ...
    HDF5-1.10.7-Linux.sh    - HDF5 Install Package
...
Installation
===========================================================================
1. Execute HDF5-1.10.7-Linux.sh
2. Follow prompts
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "/home/nate/Desktop/StreamsUtilsNP/target/debug/build/hdf5-src-794a3d6b46e0bae9/out".
